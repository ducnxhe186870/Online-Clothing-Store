...
Bộ sản phẩm Kỷ niệm sinh nhât tròn 1 năm của Front, đánh dấu sự chuyển mình của Front trong những sản phẩm sắp tới.
...
Bộ sản phẩm Kỷ niệm ngày đầu ra mắt sản phẩm, đánh dấu sự chuyển mình của Front trong những sản phẩm sắp tới. 
', CAST(N'2025-01-11' AS Date))
...
', CAST(N'2025-01-11' AS Date))
INSERT [dbo].[Post] ([postID], [tittle], [gmail], [toppic], [img], [detail], [date]) VALUES (7, N'THE NEW AGE ', N'minhnhhe186549@fpt.edu.vn', N'Product ', N'img/product_post2.jpg ', N'THE NEW AGE – marked the new transformation of Front.
...
WE Front.
', CAST(N'2025-01-11' AS Date))
INSERT [dbo].[Post] ([postID], [tittle], [gmail], [toppic], [img], [detail], [date]) VALUES (8, N'THE OBLIVIOUS LEAD ', N'minhnhhe186549@fpt.edu.vn', N'News ', N'img/news_post1.jpg ', N'Với cảm hứng từ Leather & Metal, thiết kế trong Collection mới nhất của [ Front ] được cải biên từ những bộ trang phục đặc trưng đan xen các yếu tố bí ẩn của dòng phim trinh thám cổ điển.

Sử dụng da Polyurethane cao cấp xuyên suốt Collection, cùng logo nổi sau lưng các sản phẩm chủ đạo, có thể nói FRONT chính là brand tiên phong áp dụng thành công kỹ thuật dập nổi với độ hoàn thiện cực cao trên loại chất liệu khó nhằn này.

Chốt/khóa kim loại (Metal Buckle) – có mặt trên hầu hết các sản phẩm – là chi tiết được FRONT đặc biệt đầu tư. Ngoài truyền tải nội dung Collection, Metal Buckle còn được Team thiết kế như một món phụ kiện cao cấp đích thực.
', CAST(N'2025-01-11' AS Date))
...
GO
INSERT [dbo].[Shop Information] ([Name], [Address], [Facebook], [Gmail], [Phone]) VALUES (N'Front', N'Hà Nội', N'https://www.facebook.com/dinhvando8502', N'dodvhe161048@fpt.edu.vn', N'0999999999          ')
GO
